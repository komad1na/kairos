...
function videoClipCoversCanvas(
  clip: Clip,
  asset: Asset,
  settings: ProjectSettings,
  playhead: number,
...
function transitionFactor(clip: Clip, playhead: number): number {
...
function mediaState(el: HTMLMediaElement): string {
...
function mediaErrorDescription(error: MediaError | null): string {
